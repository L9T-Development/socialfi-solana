...
export default function LandingPage() {
  ...
  const testimonials = [
    {
      quote: "SolPost has completely transformed how I share Solana code solutions with the community.",
      author: "Alex Wang",
    ...
    {
      quote: "Hosting code battles on SolPost helped us identify top talent for our DeFi project.",
      author: "Jamal Thomas",
      role: "Rust Developer",
      image: "/user3.jpg"
    }
  ...
  const faqs = [
    {
      question: "How do I earn SOL on SolPost?",
    ...
    {
      question: "Is SolPost only for advanced Solana developers?",
      answer: "Not at all! SolPost welcomes developers of all skill levels. Beginners can learn from the community's snippets and visual explainers, while more experienced developers can share knowledge and participate in advanced challenges."
    },
    {
    ...
    {
      question: "What makes SolPost different from GitHub gists or other code-sharing platforms?",
      answer: "SolPost is specifically built for Solana developers with integrated visual tools, a social ecosystem with direct SOL rewards, and focused learning resources. Our platform combines code sharing, visual learning, social interaction, and financial incentives in one ecosystem."
    }
  ]
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-muted/30 py-24">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">How SolPost Works</h2>
            <p className="text-lg text-muted-foreground">
      ...
      <section className="container mx-auto px-6 py-24">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Hear from developers already using SolPost
          </p>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between">
            <div className="mb-8 md:mb-0">
              <h3 className="text-xl font-bold mb-4">SolPost</h3>
              <p className="text-muted-foreground max-w-xs">
                 SolPost combines a snippet-sharing hub with gamified rewards. Developers create/public/private code snippets and visual explainers, while earning SOL through tips, battles, and reputation-building. Web3 companies leverage the platform to sponsor challenges, discover talent, and promote tools.
              </p>
            </div>
          ...
          <div className="border-t border-border mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground mb-4 md:mb-0">
              © {new Date().getFullYear()} SolPost. All rights reserved.
            </p>
